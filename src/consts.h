...
const char *const PLUGIN_INFO_TEMPLATE =
	"VTES Card Scanner (%1) by "
	"<a href=\"https://github.com/ChicoCifrado/VTES-for-OBS\">ChicoCifrado</a>";
const char *const PLUGIN_INFO_TEMPLATE_UPDATE_AVAILABLE =
	"<center><a href=\"https://github.com/ChicoCifrado/VTES-for-OBS/releases\">🚀 Update available! (%1)</a></center>";
